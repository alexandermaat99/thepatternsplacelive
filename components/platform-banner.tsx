...
export function PlatformBanner() {
  ...
  return (
    <div
      className={`bg-gradient-to-r from-rose-300/30 via-rose-300/10 to-rose-300/50 border-b border-rose-300/20 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-center gap-4 relative">
          <div className="flex items-center gap-3 flex-1 justify-center min-w-0">
            ...
            <p className="text-sm md:text-base text-foreground text-center">
              Welcome! We're a <span className="font-bold text-rose-400">brand new</span>{' '}
              marketplace for sewing, knitting, and other patterns. Help us grow by listing your
              patterns or sharing our site!{' '}
              <Link
                href="/marketplace/sell"
                className="font-semibold text-rose-400 hover:text-rose-500 hover:underline inline-flex items-center transition-colors"
              >
                Sell a Pattern →
              </Link>
            </p>
